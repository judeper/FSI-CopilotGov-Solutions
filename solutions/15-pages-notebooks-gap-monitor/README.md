...
|---------|-------|-----------|
| 2.11 | Copilot Pages Security and Sharing Controls | [Portal Walkthrough](docs/playbooks/control-implementations/2.11/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/2.11/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/2.11/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/2.11/troubleshooting.md) |
