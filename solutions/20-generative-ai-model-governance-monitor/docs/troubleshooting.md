...
This is expected. v0.1.3 is documentation-first. Live integration with Microsoft Graph, Microsoft Purview, Microsoft Foundry, Azure OpenAI, Azure AI Content Safety, or Sentinel is deferred.
