...
- Reconciled internal version drift: aligned `config/default-config.json`, `DELIVERY-CHECKLIST.md`, and the generated `solutions.json` entry to the already released version `v0.1.4` (they were `v0.1.3`); no new release is introduced.
