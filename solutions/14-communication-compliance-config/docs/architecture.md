...
| Purview Portal       |        | - SLA and escalation guidance    |
+----------+-----------+        +-----------------+----------------+
           |
           v
+----------+-----------+
...
### Custom Keyword Dictionary Manager

The custom keyword dictionary manager governs supervised keywords and phrases such as:
...
Keyword dictionary publishing is manual in Microsoft Purview and requires Legal and Compliance approval before production use.
...
- **Microsoft Purview portal** (purview.microsoft.com) - manual publication and ongoing reviewer operations.
