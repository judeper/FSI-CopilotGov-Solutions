...
$controls = @(
            [pscustomobject]@{ controlId = '2.10'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
    ...
    [pscustomobject]@{ controlId = '3.9'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
)
