...
1. Review [docs/prerequisites.md](docs/prerequisites.md) and confirm Microsoft 365 admin center, Teams admin center, Power Platform admin center, and Cloud Policy service access are in place.
...
Detailed requirements are listed in [docs/prerequisites.md](docs/prerequisites.md).
