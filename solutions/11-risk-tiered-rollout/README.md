...
| 1.11 | Organizational Change Management and Adoption Planning | [Portal Walkthrough](docs/playbooks/control-implementations/1.11/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/1.11/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/1.11/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/1.11/troubleshooting.md) |
| 1.12 | Training and Awareness Program | [Portal Walkthrough](docs/playbooks/control-implementations/1.12/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/1.12/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/1.12/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/1.12/troubleshooting.md) |
