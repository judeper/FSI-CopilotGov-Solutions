...
| Field | Description |
|-------|-------------|
| `runtimeMode` | Script runtime marker; `documentation-first-stub` in repository form |
| `dataSourceMode` | Data-source marker; `representative-sample` until tenant binding is added |
| `warning` | Honesty warning that evidence is generated from staged manifests and representative rollout logic |
...
| `generatedAt` | Timestamp generated by the export script |
| `runtimeMode` | Script runtime marker; `documentation-first-stub` in repository form |
| `dataSourceMode` | Data-source marker; `representative-sample` until tenant binding is added |
| `warning` | Honesty warning that the artifact uses representative rollout logic |
...
| `runtimeMode` | Script runtime marker; `documentation-first-stub` in repository form |
| `warning` | Honesty warning that the approval history is representative until workflow binding is added |
...
| `runtimeMode` | Script runtime marker; `documentation-first-stub` in repository form |
| `warning` | Honesty warning that dashboard metrics are generated from representative outputs |
