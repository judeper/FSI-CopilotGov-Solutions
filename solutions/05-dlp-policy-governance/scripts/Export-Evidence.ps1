...
$controls = @(
            [pscustomobject]@{ controlId = '2.1'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
    [pscustomobject]@{ controlId = '3.10'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
