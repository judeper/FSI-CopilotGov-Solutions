...
The solution uses PowerShell scripts for deployment, monitoring, and evidence export; configuration files for tier-specific policy; and documentation-first guidance for optional workflow automation. See [docs/architecture.md](docs/architecture.md) for the component diagram, data flow, integration points, and security considerations.
...
- PowerShell 7.2 or later with the modules documented in [docs/prerequisites.md](docs/prerequisites.md)
...
|---------|-------|-----------|
| 2.7 | Data Residency and Cross-Border Data Flow Governance | [Portal Walkthrough](docs/playbooks/control-implementations/2.7/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/2.7/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/2.7/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/2.7/troubleshooting.md) |
| 4.9 | Incident Reporting and Root Cause Analysis | [Portal Walkthrough](docs/playbooks/control-implementations/4.9/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/4.9/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/4.9/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/4.9/troubleshooting.md) |
| 4.10 | Business Continuity and Disaster Recovery for Copilot Dependency | [Portal Walkthrough](docs/playbooks/control-implementations/4.10/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/4.10/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/4.10/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/4.10/troubleshooting.md) |
| 4.11 | Microsoft Sentinel Integration for Copilot Events | [Portal Walkthrough](docs/playbooks/control-implementations/4.11/portal-walkthrough.md) / [PowerShell Setup](docs/playbooks/control-implementations/4.11/powershell-setup.md) / [Verification and Testing](docs/playbooks/control-implementations/4.11/verification-testing.md) / [Troubleshooting](docs/playbooks/control-implementations/4.11/troubleshooting.md) |
