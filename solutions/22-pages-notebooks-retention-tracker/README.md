...
The solution combines PowerShell scripts for deployment, monitoring, and evidence export with tier-specific configuration files and documentation-first guidance. See [docs/architecture.md](docs/architecture.md) for the component overview, data flow, and integration points.

## Deployment

1. Review [docs/prerequisites.md](docs/prerequisites.md) for Microsoft 365, Purview, and PowerShell requirements.
