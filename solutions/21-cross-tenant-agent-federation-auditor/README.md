...
CTAF uses PowerShell stub scripts for deployment, monitoring, and evidence export, JSON tier configuration files, and documentation-first guidance for review workflows. See [docs/architecture.md](docs/architecture.md) for the component diagram, data flow, and integration points.
