...
$controls = @(
            [pscustomobject]@{ controlId = '2.3'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
    [pscustomobject]@{ controlId = '2.6'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
    [pscustomobject]@{ controlId = '2.9'; status = 'implemented'; notes = 'Scaffold evidence entry.' }
)

Export-SolutionEvidencePackage `
    -Solution '07-conditional-access-automation' `
    -SolutionCode 'CAA' `
