...
1. Review [Prerequisites](prerequisites.md) and confirm that solutions `09-feature-management-controller` and `10-connector-plugin-governance` are already deployed.
...
See [Deployment Guide](deployment-guide.md) for detailed step-by-step instructions.
