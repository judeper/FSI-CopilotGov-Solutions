...
| Copilot configuration | AI Administrator for changes; Global Reader for read-only review | Review Microsoft 365 Copilot settings, Copilot controls scenarios, and agent governance visibility |
