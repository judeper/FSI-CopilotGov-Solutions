...
| 1.3 | monitor-only | Supports temporary discoverability governance by identifying sites/items for permission cleanup before applying Restricted Content Discovery (RCD). RSS is retiring with new enablement blocked starting 2026-07-31; RCD is site-level, doesn't change permissions, isn't a security boundary, and doesn't apply to OneDrive |
