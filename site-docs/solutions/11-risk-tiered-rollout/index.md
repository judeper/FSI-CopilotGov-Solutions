...
See [docs/architecture.md](architecture.md) for the detailed component model, flow descriptions, and wave definitions.

## Quick Start

1. Confirm that [01-copilot-readiness-scanner](../01-copilot-readiness-scanner/index.md) is deployed and has produced a current evidence package.
2. Review [docs/prerequisites.md](prerequisites.md) and confirm Microsoft 365 licensing, Graph permissions, Dataverse capacity, and the CAB process are in place.
