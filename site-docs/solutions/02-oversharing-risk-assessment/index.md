...
See [docs/architecture.md](architecture.md) for the component diagram, workload data flow, remediation modes, and Power Automate integration pattern.
...
- Restricted SharePoint Search enablement is represented as a deployment action placeholder and still requires tenant validation.
