...
Publishes communication compliance policy patterns for Copilot-assisted content and tracks reviewer workflows and escalations. This scaffold establishes the required documentation, scripts, config files, and evidence-export pattern for later implementation work.

## Features

- Maps to the following controls: 2.10, 3.4, 3.5, 3.6, 3.9
...
|---------|-------|-----------|
| 2.10 | Insider Risk Detection for Copilot Usage Patterns | [Portal Walkthrough](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/2.10/portal-walkthrough.md) / [PowerShell Setup](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/2.10/powershell-setup.md) / [Verification and Testing](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/2.10/verification-testing.md) / [Troubleshooting](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/2.10/troubleshooting.md) |
...
| 3.9 | AI Disclosure, Transparency, and SEC Marketing Rule | [Portal Walkthrough](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/3.9/portal-walkthrough.md) / [PowerShell Setup](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/3.9/powershell-setup.md) / [Verification and Testing](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/3.9/verification-testing.md) / [Troubleshooting](https://github.com/judeper/FSI-CopilotGov/blob/main/docs/playbooks/control-implementations/3.9/troubleshooting.md) |

## Regulatory Alignment

This solution supports compliance with: FINRA 2210, FINRA 3110, SEC Reg BI, FCA SYSC 10.

## Evidence Export

The solution is expected to publish: policy-template-export, reviewer-queue-metrics, lexicon-update-log. Evidence packages must align to `../../data/evidence-schema.json`.
