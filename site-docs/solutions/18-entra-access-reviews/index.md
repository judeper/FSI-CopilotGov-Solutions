...
> **Status:** Documentation-first scaffold | **Version:** v0.1.5 | **Priority:** P1 | **Track:** A
...
- Review [docs/prerequisites.md](prerequisites.md) and confirm the required admin roles, PowerShell modules, and Microsoft Entra ID Governance licensing are in place.
- Verify that solution [02-oversharing-risk-assessment](../02-oversharing-risk-assessment/index.md) has produced risk-scored site output that can be used to prioritize review creation for mapped Microsoft Entra resources.
