...
class LabValidationTests(unittest.TestCase):
    def test_contract_validator_discovers_repository_contracts(self) -> None:
        ...
        self.assertIn(
            "14-communication-compliance-config.lab.json",
            result.stdout,
            msg="default discovery should include the Solution 14 lab contract",
        )

    def test_contract_validator_accepts_solution_14_contract(self) -> None:
        contract_path = (
            ROOT
            / "solutions"
