...
class LabValidationTests(unittest.TestCase):
    def test_contract_validator_discovers_repository_contracts(self) -> None:
        ...
        self.assertIn(
            "05-dlp-policy-governance.lab.json",
            result.stdout,
            msg="default discovery should include the Solution 05 lab contract",
        )

    def test_contract_validator_accepts_solution_05_contract(self) -> None:
        contract_path = (
            ROOT
            / "solutions"
