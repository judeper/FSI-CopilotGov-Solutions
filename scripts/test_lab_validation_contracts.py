...
class LabValidationTests(unittest.TestCase):
    ...
    def test_contract_validator_accepts_solution22_repository_contract(self) -> None:
        contract_path = (
            ROOT
            / "solutions"
            / "22-pages-notebooks-retention-tracker"
            / "lab"
            / "22-pages-notebooks-retention-tracker.lab.json"
        )
