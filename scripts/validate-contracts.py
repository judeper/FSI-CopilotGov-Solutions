...
REQUIRED_FILES = [
    ...
    ROOT / "docs" / "reference" / "lab-validation-contract.md",
    ...
    ROOT / "data" / "lab-validation-contract.schema.json",
    ROOT / "data" / "lab-validation-result.schema.json",
    ROOT / "scripts" / "solution-config.yml",
    ROOT / "scripts" / "validate-lab-contracts.py",
    ROOT / "scripts" / "validate-lab-result.py",
    ROOT / "scripts" / "validate-lab-package.ps1",
    ROOT / "scripts" / "test_lab_validation_contracts.py",
